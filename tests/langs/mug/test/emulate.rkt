...
(define test-specs
  `(["Abscond"   [ 7 [ 7]]
    ...
    ["Knock"     [err     [(match 1)]]
                 [2       [(match 1 [1 2])]]
                 [2       [(match 1 [2 1] [1 2])]]
                 [2       [(match 1 [2 1] [1 2] [0 3])]]
                 [err     [(match 1 [2 1] [0 3])]]
                 [2       [(match 1 [_ 2] [_ 3])]]
                 [2       [(match 1 [x 2] [_ 3])]]
                 [1       [(match 1 [x x] [_ 3])]]
                 [(1 . 2) [(match (cons 1 2) [x x] [_ 3])]]
                 [1       [(match (cons 1 2) [(cons x y) x] [_ 3])]]
                 [1       [(match (cons 1 2) [(cons x 2) x] [_ 3])]]
                 [3       [(match (cons 1 2) [(cons 3 2) 0] [_ 3])]]
                 [3       [(match 1 [(cons x y) x] [_ 3])]]
                 [2       [(match (cons 1 2) [(cons 1 3) 0] [(cons 1 y) y] [_ 3])]]
                 [0       [(match (box 1) [(box 1) 0] [_ 1])]]
                 [1       [(match (box 1) [(box 2) 0] [_ 1])]]
                 [1       [(match (box 1) [(box x) x] [_ 2])]]]
...
(module+ test
  ...
  (run-test-specs "Mug" test-specs run)

  #;(run-test-specs "Mug / IO" test-specs/io run/io))
